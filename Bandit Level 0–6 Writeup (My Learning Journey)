...
🔍 Approach
This level introduced me to SSH (Secure Shell) and how remote login works in real-world environments.
...
🔍 Approach
After logging in, I used basic Linux commands:
ls
cat readme
...
When I tried:
cat -
It gave an error because the terminal interpreted - as a special argument instead of a filename.
...
🔍 Problem Faced
Even with ./, the terminal could not recognize the file properly due to spaces in the filename.
...
I first used:
ls -lh
to inspect file sizes and details manually.

⚡ Optimized Approach
To be more efficient, I used:
...
🔍 Approach
Instead of manually checking each file, I refined my find command:
...
💡 Final Reflection
These early Bandit levels significantly improved my Linux fundamentals and taught me the importance of enumeration, attention to detail, and understanding how the terminal interprets commands.
Rather than blindly copying solutions, I focused on understanding the logic behind each step, which is essential for cybersecurity, penetration testing, and real-world security analysis.
this repository represents my practical journey into cybersecurity through hands-on learning and CTF-based challenges.
